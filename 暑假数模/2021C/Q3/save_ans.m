...
ret(ret==0) = NaN;
writematrix(ret, '附件A 订购方案数据结果.xlsx', 'Sheet', '问题3的订购方案结果', 'Range', 'B7:Y408')
...
fang(fang==0) = NaN;
writematrix(fang, '附件B 转运方案数据结果.xlsx', 'Sheet', '问题3的转运方案结果', 'Range', 'B7:GK408')
